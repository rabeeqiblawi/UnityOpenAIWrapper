...
public static class SaveWav
{
    ...
    public static byte[] Save(this AudioSource audioSource, string filename, System.Action onDone=null)
    {
        ...
        using (var memoryStream = CreateEmpty())
        {
            ...
            // The memoryStream.ToArray() method ensures that only the relevant bytes are written.
